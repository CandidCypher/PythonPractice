...
class MagicArcher(Wizzard, Archer):
    """
    Info: Magical archer that has multiple inheritance
    """
    def __init__(self, name, age, 
                 wizzard_data:WizzardCharacterData, 
                 archer_data:ArcherCharacterData):
        """
        Info: Multiple inheritance initialization can be messy. 
        """
        Archer.__init__(self, name, age, archer_data.bow_type)
        Wizzard.__init__(self, name, age, 
                         wizzard_data.magic_type, 
                         wizzard_data.magic_points, 
                         wizzard_data.cooldown_time)
